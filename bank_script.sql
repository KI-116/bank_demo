...
drop table if exists employee_and_customer;
...
(
   departm_id           varchar(30) not null,
   BranchName           varchar(30),
   department_name      varchar(30) not null,
   department_type      varchar(30) not null,
   manager_id           varchar(30) not null,
   primary key (departm_id)
);
...
(
   ...
   departm_id           varchar(30),
   employee_name        varchar(30) not null,
   employee_tel         varchar(30) not null,
...
/*==============================================================*/
/* Table: employee_and_customer                                 */
/*==============================================================*/
create table employee_and_customer
(
   employee_id          varchar(30) not null,
   customer¡¤_id         char(20) not null,
   primary key (employee_id, customer¡¤_id)
);
...
(
   ...
   payment_mpney        decimal not null,
...
alter table cheque add constraint FK_cheque_to_account foreign key (account_id)
...
alter table department add constraint FK_bank_and_department foreign key (BranchName)
      references Branch (BranchName) on delete restrict on update restrict;

alter table employee add constraint FK_employee_and_department foreign key (departm_id)
      references department (departm_id) on delete restrict on update restrict;

alter table employee_and_customer add constraint FK_6 foreign key (employee_id)
      references employee (employee_id) on delete restrict on update restrict;

alter table employee_and_customer add constraint FK_62 foreign key (customer¡¤_id)
      references customer (customer¡¤_id) on delete restrict on update restrict;

alter table payment add constraint FK_loan_and_payment foreign key (loan_id)
      references loan (loan_id) on delete restrict on update restrict;

alter table saving add constraint FK_saving_to_account foreign key (account_id)
      references account (account_id) on delete restrict on update restrict;
